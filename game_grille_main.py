...
texte1 = affiche_texte("hello",1000,30,(255,255,255),win)
...
while run:
    ...
    EVENT = Event_manipulation(events, run, [pygame.K_a, pygame.K_z, pygame.K_e],[ pygame.K_q ,pygame.K_s ,pygame.K_d   ])
